...
<div class="container"></div>
    ...
    @if(isset($whistle))
            ...
            <tr>
                ...
                <td>
                    @if($whistle->foto_bukti)
                        <a href="{{ route('public-whistle.image', ['id' => $whistle->id]) }}" class="btn btn-sm btn-info" target="_blank">Lihat Bukti</a>
                    @else
        ...
        <a href="{{ route('public.whistles') }}" class="btn btn-secondary">Kembali</a>
    @else

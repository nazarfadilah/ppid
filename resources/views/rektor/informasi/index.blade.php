...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                <div class="row">
                    ...
                    <div class="col-6 mb-3"><div class="card bg-success text-white"><div class="card-body"><h5 class="card-title">Approved</h5><h2 id="approvedRequests">0</h2></div></div></div>
                    <div class="col-6"><div class="card bg-danger text-white"><div class="card-body"><h5 class="card-title">Rejected</h5><h2 id="rejectedRequests">0</h2></div></div></div>
                    <div class="col-6"><div class="card bg-warning text-dark"><div class="card-body"><h5 class="card-title">Checking</h5><h2 id="pendingRequests">0</h2></div></div></div>
                </div>
            </div>
        </div>
        ...
        <h4 class="mt-4">Detail Permohonan Informasi</h4>
        <div class="row mb-3">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function fetchData(page = 1) {
        ...
        const url = "{{ route('rektor-informasi-statistics') }}?" + new URLSearchParams(filters);
        fetch(url)
            .then(response => response.ok ? response.json() : Promise.reject('Network Error'))
            .then(data => {
                updateChart(data.chartData);
                updateSummaryStats(data.chartData.summary);
                document.getElementById('requestTableBody').innerHTML = data.table_html;
    ...
    function updateChart(chartData) {
        ...
        statisticChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    data: chartData.byStatus.values,
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: 'Permohonan Berdasarkan Status'
                    }
                }
            }
        });

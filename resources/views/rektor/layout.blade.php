...
<body>
    <div class="container-fluid">
        <div class="row">
            @include('rektor.navbar')
            <nav class="col-md-2 d-flex flex-column flex-shrink-0 p-3 bg-light ">
                <div class="sidebar-sticky">
                    <ul class="nav nav-pills flex-column mb-auto">
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center text-black {{ request()->routeIs('rektor.dashboard*') ? 'active' : '' }}" aria-current="page" href="{{ route('rektor-dashboard') }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center text-black {{ request()->routeIs('gallery*') ? 'active' : '' }}" href="{{ route('rektor-gallery') }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center text-black {{ request()->routeIs('request*') ? 'active' : '' }}" href="{{ route('rektor-informasi') }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center text-black {{ request()->routeIs('objection*') ? 'active' : '' }}" href="{{ route('rektor-keberatan') }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center text-black {{ request()->routeIs('whistles*') ? 'active' : '' }}" href="{{ route('rektor-whistle') }}">

...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        <a href="{{ route('admin-request') }}" class="btn btn-secondary mb-3">Kembali ke Daftar</a>
            ...
            <div class="card-body">
                <form>
                    ...
                    <div class="mb-3">
                        ...
                        @if($request->ktp)
                            <div>
                                <a href="{{ route('admin-informasi.ktp', ['id' => $request->id]) }}" target="_blank" class="btn btn-sm btn-primary">Lihat Scan KTP</a>
                            </div>
                        @else

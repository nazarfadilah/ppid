...
<div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
    ...
    <div class="page-wrapper">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered" id="objectionTable">
                ...
                <tbody>
                    ...
                    <tr data-created="{{ $obj->created_at->format('Y-m-d') }}">
                        ...
                        <td>{{ $obj->status }}</td>
                        <td>
                            <a href="{{ route('admin-objection-detail', $obj->id) }}" class="btn btn-sm btn-info">Detail</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
        ...
        <div class="modal-dialog">
            <form action="{{ route('admin-objection-export') }}" method="POST" target="_blank">
                @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="year" id="year" class="form-select" required>
                                @php
                                    $years = \App\Models\Objection::selectRaw('YEAR(created_at) as year')
...
document.addEventListener('DOMContentLoaded', function () {
    const table = document.querySelector('#objectionTable tbody');

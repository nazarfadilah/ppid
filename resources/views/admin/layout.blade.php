            ...
            <nav class="col-md-2 d-flex flex-column flex-shrink-0 p-3 bg-light ">
                <div class="sidebar-sticky">
                    <ul class="nav nav-pills flex-column mb-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center text-black {{ request()->routeIs('gallery*') ? 'active' : '' }}" href="{{ route('admin-gallery') }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center text-black {{ request()->routeIs('request*') ? 'active' : '' }}" href="{{ route('admin-request') }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center text-black {{ request()->routeIs('objection*') ? 'active' : '' }}" href="{{ route('admin-objection') }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center text-black {{ request()->routeIs('whistles*') ? 'active' : '' }}" href="{{ route('admin-whistle') }}">

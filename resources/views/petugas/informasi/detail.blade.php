...
<div class="page-wrapper">
    <div class="page-breadcrumb">
        <h3 class="page-title">Detail Pengajuan Informasi Publik</h3>
    </div>

    <div class="container-fluid">
        <a href="{{ route('petugas-informasi') }}" class="btn btn-secondary mb-3">Kembali ke Daftar</a>
            ...
            <div class="card-body">
                <form>
                    ...
                    <div class="mb-3">
                        ...
                        @if($request->ktp)
                            <div>
                                <a href="{{ route('petugas-informasi.ktp', ['id' => $request->id]) }}" target="_blank" class="btn btn-sm btn-primary">Lihat Scan KTP</a>
                            </div>
                        @else

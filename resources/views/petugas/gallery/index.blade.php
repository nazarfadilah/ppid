        ...
        <div class="page-breadcrumb">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 col-4 text-end">
                    <a href="{{ route('petugas-galeri-create') }}" class="btn btn-primary">
                        Tambah Galeri
                    </a>
                </div>
            </div>
        ...
        <div class="table-responsive-sm mt-2">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $gallery->date }}</td>
                    <td>
                    <a href="{{ route('petugas-galeri-edit', $gallery->id) }}" class="btn btn-sm btn-warning">Edit</a>
                    <form action="{{ route('galleries.destroy', $gallery->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus galeri ini?')">
                        @csrf
                        @method('DELETE')

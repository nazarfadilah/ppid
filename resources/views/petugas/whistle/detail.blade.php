...
<div class="container"></div>
    <h2>Detail Laporan Pengaduan Whistle Blowing</h2>
    @if(isset($whistle))
            ...
            <tr>
                ...
                <td>
                    @if($whistle->foto_bukti)
                        <a href="{{ route('whistle.image', ['id' => $whistle->id]) }}" target="_blank">Lihat Bukti</a>
                    @else
        ...
        <a href="{{ route('petugas-whistle-bowling') }}" class="btn btn-secondary">Kembali</a>
    @else
